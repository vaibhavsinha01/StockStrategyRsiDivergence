...
import hashlib
import json
from creds import secret, key  # Ensure this file contains your secret and key securely
...
class Broker:
    ...
    def place_order(symbol):
        ...
        signature = Broker.create_signature(secret, method, url, payload)
...
# Login
login_response = Broker.login(key, secret)
